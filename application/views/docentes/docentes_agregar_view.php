  <div class="row">
    ...
    <div class="col-md-12">
      ...
      <div class="box box-primary">
        ...
        <!-- /.box-header -->
        <!-- form start -->
        <?php echo form_open('docentes/agregar_s'); ?>
          <div class="box-body">
          	<div class="row">
          		<div class="col-md-12">
          			<div class="row">
						<?php if($this->session->flashdata('agregar_docente')): ?>
				            <div class="col-md-12">
				              <div class="alert alert-success alert-dismissible">
				                  <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
				                  <h4><i class="icon fa fa-check"></i> Correcto!</h4>
				                  <?php echo $this->session->flashdata('agregar_docente'); ?>
				                </div>
				            </div>
				          <?php endif; ?>
			            ...
			            <div class="col-md-3">
		          		...
		          		<div class="col-md-12">
		          			<div class="form-group <?php echo (form_error('escuela')) ? 'has-error' : ''; ?>">
				                ...
				                <?php echo form_dropdown('escuela', $escuelas, set_value('escuela'), array('class' => 'form-control')); ?>
				                <?php echo form_error('escuela', '<span class="help-block">', '</span>'); ?>
				            </div>
		          		</div>

		          		<div class="col-md-6">
		          			<div class="form-group <?php echo (form_error('contrasena')) ? 'has-error' : ''; ?>">
				                <?php echo form_label('Contraseña:'); ?>
				                <?php echo form_password('contrasena', set_value('contrasena'), array('class'=>'form-control')); ?>
				                <?php echo form_error('contrasena', '<span class="help-block">', '</span>'); ?>
				            </div>
		          		</div>

		          		<div class="col-md-6">
		          			<div class="form-group <?php echo (form_error('tipo_usuario')) ? 'has-error' : ''; ?>">
				                <?php echo form_label('Tipo de usuario:'); ?>
				                <?php echo form_dropdown('tipo_usuario', $tipos_usuario, set_value('tipo_usuario'), array('class' => 'form-control')); ?>
				                <?php echo form_error('tipo_usuario', '<span class="help-block">', '</span>'); ?>
				            </div>
		          		</div>
          			</div>	
          		</div>
          ...
          <div class="box-footer">
            <?php echo form_submit('', 'Guardar docente', array('class'=>'btn btn-primary')); ?>
